...
/// Time is double precision to preserve phase accuracy over long sessions.
/// </summary>
public interface ISacredLayer
{
    ...
    /// </summary>
    /// <param name="tChunk">Absolute time values for this chunk (seconds, double precision)</param>
    ...
    float[] ComputeChunk(ReadOnlySpan<double> tChunk, float totalDuration);
}
